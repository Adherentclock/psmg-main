...
class GetPrediagnosticosSinSeguimiento {
  final Address address = Address();
  final storage = const FlutterSecureStorage();
  Future<dynamic> getPrediagnsoticosSinSeguimiento() async {
    final String? token = await storage.read(key: 'token');
    var url = Uri.http(address.getAddress(), '/api/pred-sin-seguimiento');

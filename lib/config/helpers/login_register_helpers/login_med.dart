...
class LoginMed {
  ...
  Future<String> loginMed(String correo, String contrasena) async {
    var url = Uri.http(address.getAddress(), '/api/login-med');
    ...
    if (response.statusCode == 200) {
      if (decodificado['status'] != 2) {
        ...
        await storage.write(key: 'user', value: decodificado['no']);
